	...
	for (;;) {
		...
		if (Input.EventType == MOUSE_EVENT) {
			if (Input.Event.MouseEvent.dwButtonState == FROM_LEFT_1ST_BUTTON_PRESSED) {
				...
				//opciones del menú (la opciones de push ,pop etc para pilas y Colas)
				if (coord.X >= 15 && coord.X <= 40 && coord.Y == 7) {//24 es el numero letras + espacios vacios que tiene esa opcion
					return 1;
				}
				if (coord.X >= 15 && coord.X <= 46 && coord.Y == 8) {//10 es el numero letras + espacios vacios que tiene esa opcion
					return 2;
				}
				...
				if (coord.X >= 15 && coord.X <= 21 && coord.Y == 13) {//5 es el numero letras + espacios vacios que tiene esa opcion
					return 7;
				}
				if (coord.X >= 15 && coord.X <= 21 && coord.Y == 14) {//5 es el numero letras + espacios vacios que tiene esa opcion
					return 8;
				}
				if (coord.X >= 15 && coord.X <= 21 && coord.Y == 15) {//5 es el numero letras + espacios vacios que tiene esa opcion
					return 9;
				}
				if (coord.X >= 15 && coord.X <= 21 && coord.Y == 16) {//5 es el numero letras + espacios vacios que tiene esa opcion
					return 10;
				}
				if (coord.X >= 15 && coord.X <= 21 && coord.Y == 17) {//5 es el numero letras + espacios vacios que tiene esa opcion
					return 11;
				}
				if (coord.X >= 15 && coord.X <= 21 && coord.Y == 18) {//5 es el numero letras + espacios vacios que tiene esa opcion
					return 12;
				}
